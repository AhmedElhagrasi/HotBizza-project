	...
	public Node getPrintableText() {
		...
		StringBuilder header5 = new StringBuilder();
  		 ...
  		 header1.append("\n       HOT PIZZA"  + " \n");
 			...
 			header4.append("      Contact Us: "  + "\n");
 			header4.append("      01092447384 - 01129780434 - 0502221386"  + "\n");

 			header4.append("          FACEBOOK.COM /HOTPIZZA" + "\n");
 			header4.append("          INSTAGRAM.COM/HOTPIZZA" + "\n\n");
 			header4.append( "ش/سعيد الشرقاوى متفرع من ش/احمد ماهر        "
